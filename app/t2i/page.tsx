...
export default function HomePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/t2i-queue-task`, {
            method: 'POST',
            headers: {
        ...
        const interval = setInterval(async () => {
            const resultRes = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/t2i-get-result?taskId=${taskId}`);
